...
# ABOUTME: Provides a small wrapper for running causal language models.
...
class Small_LLM_Model:
    ...
    def encode(self, text: str) -> torch.Tensor:
        """Tokenise text into a 2-D tensor on the target device."""
    ...
    def get_logits_from_input_ids(self, input_ids: list[int]) -> list[float]:
        ...
        # Get logits for the last position in the single-item batch.
